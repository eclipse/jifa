...
//      expected result:  events[5].setMemoryItem(new GCCollectionResultItem(OLD,10,12,100));
    ...
    public void testModelMisc() {
        ...
        // single event info
        Assertions.assertEquals(model.getGcEvents().get(0).getAllocation(), 40 * 1024 * 1024);
        Assertions.assertEquals(model.getGcEvents().get(0).getPromotion(), 2 * 1024 * 1024);
        Assertions.assertEquals(model.getGcEvents().get(0).getReclamation(), 8 * 1024 * 1024);
        ...
        Assertions.assertEquals(model.getGcEvents().get(0).getMemoryItem(HEAP),
        ...
        Assertions.assertEquals(objectStatistics.getObjectCreationSpeed(), (40 + 18 + 22 + 40 + 6) * 1024 * 1024 / 31800.0, DELTA);
        ...
        Assertions.assertEquals(pauseStatistics.getThroughput(), 1 - (1000 + 100 + 200 + 200 + 400) / 20000.0, DELTA);
        Assertions.assertEquals(pauseStatistics.getPauseAvg(), (1000 + 100 + 200 + 200 + 400) / 5.0, DELTA);
        Assertions.assertEquals(pauseStatistics.getPauseMedian(), 200, DELTA);
        Assertions.assertEquals(pauseStatistics.getPauseP99(), 0.96 * 1000 + 0.04 * 400, DELTA);
        Assertions.assertEquals(pauseStatistics.getPauseP999(), 0.996 * 1000 + 0.004 * 400, DELTA);
        Assertions.assertEquals(pauseStatistics.getPauseMax(), 1000.0, DELTA);
        ...
        Assertions.assertEquals(parents.get(0).getCauses().size(), 1);
        Assertions.assertEquals(parents.get(2).getCauses().size(), 2);
        Assertions.assertEquals(parents.get(0).getCauses().get(0), new PhaseStatistics.PhaseStatisticItem(
                "G1 Evacuation Pause", 2, 30500, 30500, 400, 500, 800));
        Assertions.assertEquals(parents.get(1).getSelf(), new PhaseStatistics.PhaseStatisticItem(
                G1_CONCURRENT_CYCLE.getName(), 2, 6800, 6800, 900, 1200, 1800));
        Assertions.assertEquals(parents.get(1).getPhases().size(), 3);
        Assertions.assertEquals(parents.get(1).getPhases().get(1), new PhaseStatistics.PhaseStatisticItem(
    ...
    public void testUseCPUTimeAsPause() throws Exception {
        ...
        Assertions.assertEquals(model.getGcEvents().get(0).getPause(), 710, DELTA);
    }
            ...
            if (parent.getSelf().getName().equals(FULL_GC.getName())) {
                for (PhaseStatistics.PhaseStatisticItem cause : parent.getCauses()) {
                    if (cause.getName().equals(GCCause.ALLOCATION_FAILURE.getName())) {
                        Assertions.assertEquals(cause.getCount(), 3);
                        Assertions.assertEquals(cause.getIntervalMin(), 24884.9386, DELTA);
                        Assertions.assertEquals(cause.getIntervalAvg(), (24884.9386 + 34884.9386) / 2, DELTA);
                        return;
                    }
                }
            }
