...
public class TestObjectStatistics {
    ...
    public void testJDk8CMS() throws Exception {
        ...
        Assertions.assertEquals(memStats.getYoung(), new MemoryStatistics.MemoryStatisticsItem(
                (1922432 * 7 + 1922492) * 1024L / 8, 1922432 * 1024L, UNKNOWN_INT, UNKNOWN_INT));
        Assertions.assertEquals(memStats.getOld(), new MemoryStatistics.MemoryStatisticsItem(
                (2097152 * 7 + 4019584 - 1922492) * 1024L / 8, 1572984 * 1024L, (1048576 + 1048592) * 1024L / 2, (2338509 - 1920339 + 2298321 - 1919804) * 1024L / 2));
        Assertions.assertEquals(memStats.getHumongous(), new MemoryStatistics.MemoryStatisticsItem(UNKNOWN_INT, UNKNOWN_INT, UNKNOWN_INT, UNKNOWN_INT));
        Assertions.assertEquals(memStats.getHeap(), new MemoryStatistics.MemoryStatisticsItem(
                4019584 * 1024L, 3212959 * 1024L, (1048576 + 1048592) * 1024L / 2, UNKNOWN_INT));
        Assertions.assertEquals(memStats.getMetaspace(), new MemoryStatistics.MemoryStatisticsItem(
    ...
    public void testJDK11G1() throws Exception {
        ...
        MemoryStatistics memStats = model.getMemoryStatistics(new TimeRange(0, 9999999999.0));
        Assertions.assertEquals(memStats.getHumongous(), new MemoryStatistics.MemoryStatisticsItem(
