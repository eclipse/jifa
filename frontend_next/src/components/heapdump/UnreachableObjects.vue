...
const tableProps = ref({
  columns: [
    ...
    },
    {
      ...
      contentOfSummary: (d) => prettyCount(d.objects)
    },
    {
      label: 'Shallow Heap',
      width: 130,
      ...
      contentOfSummary: (d) => prettySize(d.shallowSize)
    }
  ],

  apis: [
    {
      api: 'unreachableObjects.records',
      paged: true,
      summaryApi: 'unreachableObjects.summary'
    }
  ],
