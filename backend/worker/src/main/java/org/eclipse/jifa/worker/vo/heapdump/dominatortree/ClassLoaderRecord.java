...
public class ClassLoaderRecord extends BaseRecord implements Searchable {
    private static Map<String, Comparator> sortTable = new SortTableGenerator()
            .add("id", ClassLoaderRecord::getObjectId)
            .add("shallowHeap", ClassLoaderRecord::getShallowSize)
            .add("retainedHeap", ClassLoaderRecord::getRetainedSize)
            .add("percent", ClassLoaderRecord::getPercent)
            .add("Objects", ClassLoaderRecord::getObjects)
            .build();
    private long objects;

    public static Comparator<ClassLoaderRecord> sortBy(String field, boolean ascendingOrder) {
